...
function calculateITData() {
    const startPressure = parseFloat(document.getElementById('it-start-pressure').value) || 0;
    const endPressure = parseFloat(document.getElementById('it-end-pressure').value) || 0;
    const deltaSpan = document.getElementById('it-delta');
    const resultSpan = document.getElementById('it-result');
...
document.getElementById('it-start-pressure').addEventListener('input', calculateITData);
document.getElementById('it-end-pressure').addEventListener('input', calculateITData);
...
document.getElementById('print-button').addEventListener('click', function() {
    ...
    const itStart = document.getElementById('it-start-pressure').value;
    const itEnd = document.getElementById('it-end-pressure').value;
    const itDelta = document.getElementById('it-delta').textContent;
    const itResult = document.getElementById('it-result').textContent;
    ...
    const reportContent = `
        ...
        <body>
            ...
            <div class="report-section">
                ...
                <div class="data-field"><strong>Start Pressure:</strong> ${itStart}</div>
                <div class="data-field"><strong>End Pressure:</strong> ${itEnd}</div>
                <div class="data-field"><strong>Delta psi:</strong> ${itDelta}</div>
                <div class="data-field"><strong>Result:</strong> ${itResult}</div>
            </div>
            <div class="report-section">
...
document.getElementById('export-button').addEventListener('click', function() {
    ...
    const data = {
        ...
        'Yesterday IT Start Pressure': document.getElementById('it-start-pressure').value,
        'Yesterday IT End Pressure': document.getElementById('it-end-pressure').value,
        'Yesterday IT Delta psi': document.getElementById('it-delta').textContent,
        'Yesterday IT Result': document.getElementById('it-result').textContent,
